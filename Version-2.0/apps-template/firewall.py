...
def GenerateConfig(context):
    ...
    host_project = context.properties['host_project']
    trust_network = context.properties['network']
    network_ref = COMPUTE_URL_BASE + 'projects/' + host_project + '/global/' + 'networks/' + trust_network
