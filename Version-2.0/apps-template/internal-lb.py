...
def GenerateConfig(context):
    ...
    app_trust_vpc_project, trust_network = context.properties['network'].split('/')
    app_trust_vpc_project, trust_subnet = context.properties['subnet'].split('/')

    network_ref = COMPUTE_URL_BASE + 'projects/' + app_trust_vpc_project + '/global/' + 'networks/' + trust_network
    subnet_ref = COMPUTE_URL_BASE + 'projects/' + app_trust_vpc_project + '/regions/' + context.properties['region']+ '/subnetworks/' + trust_subnet
